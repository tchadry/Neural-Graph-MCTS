...
class Coach():
    ...
    def executeEpisode(self):
        ...
        """
        trainExamples = []
        # Initial state for TSP, needs to be modified for other problems
        ...
        for i in range(1, self.args.numIters+1):
            ...
            if not self.skipFirstSelfPlay or i>1:
                ...
                for eps in range(self.args.numEps):
                    ...
                    bar.suffix  = 'Eps Time: {et:.3f}s | Total: {total:} | ETA: {eta:}'.format(eps=eps+1, maxeps=self.args.numEps, et=eps_time.avg,
    ...
    def getCheckpointFile(self, iteration):
        return 'checkpoint_' + str(self.args.numMCTSSims) + 'sims_'+ str(iteration) + '.pth.tar'
